export const abi = [
  ...
  },
  {
    ...
    outputs: [
      { internalType: "contract IGitcoinResolver", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [
      { internalType: "address", name: "_easContractAddress", type: "address" },
    ],
    name: "setEASAddress",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [
      { internalType: "address", name: "_gitcoinResolver", type: "address" },
    ],
