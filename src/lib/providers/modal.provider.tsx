...
const ModalWrapper = ({
    ...
    const modalAnimation = useMemo(() => {
        if (options?.sideModal) {
            return isClosing ? "animate__animated animate__fadeOutRight animate__faster ease-out-circ pointer-events-none" : "animate__animated animate__fadeInRight animate__faster ease-out-circ"
        } else {
            return isClosing ? "animate__animated animate__fadeOut animate__faster pointer-events-none" : "animate__animated animate__fadeIn animate__faster"
        }
            ...
            >
                <Card className="h-full flex flex-col">
                    <CardHeader className="relative !pb-6">
                        ...
                        <div className="absolute right-2 top-2 w-8 h-8 cursor-pointer" onClick={() => handleClose(close)}>
                            X
                        </div>
                    </CardHeader>
                    <CardContent className="flex-1 flex flex-col justify-center items-center">{children}</CardContent>
                    {question && (
